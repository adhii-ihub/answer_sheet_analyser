            ...
            >
                ...
                <div className="bento-card p-8 md:p-10">
                    ...
                    <p className="text-sm text-gray-500 mb-8">
                        Sign in to the Controller of Examinations portal.
                    </p>
                    ...
                    <form onSubmit={handleSubmit} className="flex flex-col gap-5">
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className="btn-accent w-full flex items-center justify-center gap-2 mt-2 disabled:opacity-70 disabled:cursor-not-allowed"
                        >
                            {loading ? (
                                <>
                    ...
                    <p className="text-sm text-center text-gray-500 mt-6">
                        ...
                        <Link href="/signup" className="text-[#1A73E8] font-medium hover:underline">
                            Create one
                        </Link>
                    </p>
                </div>
